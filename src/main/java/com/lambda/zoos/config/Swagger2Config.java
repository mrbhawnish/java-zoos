...
public class Swagger2Config
{
    ...
    {
        return new ApiInfoBuilder().title("Zoos Project With Endpoints For Clients")
            .description("Zoos project by Bhawnish")
            .contact(new Contact("Bhawnish Kumar",
                "http://www.lambdaschool.com",
                "bhawnishk@lambdaschool.com"))
            .license("MIT")
